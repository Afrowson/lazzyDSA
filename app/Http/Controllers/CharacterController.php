...
class CharacterController extends Controller
{
    ...
    public function addLanguages(Request $reqest, Character $character)
    {
        
        $languages = $reqest->except('_token');
        Log::info($languages);
    ...
    public function addLetterings(Request $reqest, Character $character)
    {
        
        $letterings = $reqest->except('_token');
