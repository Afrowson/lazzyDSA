<div class="col-span-4 row-span-2 m-2">
    <div class="bg-gray-400 px-5 py-4 rounded h-full">
        ...
        <div class="flex flex-col">
            ...
            <div class="flex flex-row justify-between bg-gray-200 p-10 mt-5 rounded">
                <div>
